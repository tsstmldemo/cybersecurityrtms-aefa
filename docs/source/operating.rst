[cybersecurityrtms-aefa] Operating Details
====================================
...
.. code-block::
   ...
   docker run -d -p 5055:5055 -p 4045:4045 -p 6065:6065 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=5055 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          -v /your_localmachine/foldername:/rawdata:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=4045 \
          --env SOLUTIONVIPERVIZPORT=6065 \
          --env DOCKERUSERNAME='' \
          --env EXTERNALPORT=39399 \
...
It can be accessed by entering: http://localhost:4045
...
.. important::
   http://localhost:6065/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5055, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=39603, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=46771, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=35873, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=46569, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=36123, HPDEHOST=172.17.0.2, HPDEPORT=46025, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=43463

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3899-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, python-preprocess-9778-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, python-preprocess3-6996-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
