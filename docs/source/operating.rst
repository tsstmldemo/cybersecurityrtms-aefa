...
.. code-block::
   ...
   docker run -d -p 5055:5055 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5055, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=41863, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=39805, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=42291, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=41297, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=43761, HPDEHOST=172.17.0.2, HPDEPORT=35357, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=46545

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5957-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, python-preprocess-2080-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, python-preprocess3-8225-cybersecurityrtms-aefa,solution_preprocessing_dag-cybersecurityrtms-aefa, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
