Scaling [cybersecurityrtms-aefa] With Kubernetes
===========================

Generated On: 2025-04-02 12:37:48 UTC
...
Based on your TML solution [cybersecurityrtms-aefa] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurityrtms-aefa.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurityrtms-aefa.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurityrtms-aefa.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f cybersecurityrtms-aefa.yml

cybersecurityrtms-aefa.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurityrtms-aefa.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# cybersecurityrtms-aefa.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurityrtms-aefa
     spec:
       selector:
         matchLabels:
           app: cybersecurityrtms-aefa
         ...
         spec:
           ...
           - name: cybersecurityrtms-aefa
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'cybersecurityrtms-aefa'                              
             - name: SOLUTIONNAME
               value: 'cybersecurityrtms-aefa'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-cybersecurityrtms-aefa'
             - name: GITUSERNAME
               value: 'tsstmldemo'
             - name: GITREPOURL
               value: 'https://github.com/tsstmldemo/tsstmldemo'
             ...
             - name: step4csearchterms # STEP 4c 
               value: 'rgx:p([a-z]+)ch ~~~ |authentication failure,--entity-- password failure'               
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurityrtms-aefa-visualization-service
       labels:
         app: cybersecurityrtms-aefa-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurityrtms-aefa 6065:6065

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:6065/dashboard-rtms.html?topic=rtms-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurityrtms-aefa.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurityrtms-aefa.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurityrtms-aefa.yml
